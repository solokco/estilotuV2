...
?>
	...
	<article id="post-<?php get_the_ID(); ?>" <?php post_class(array("post-item")); ?>>
	<div class="post-content animated animate-when-almost-visible el-appear">
		...
		/* ******************************************** */
		if ( isset($opciones_servicio['bloque_lunes'][0]) )	
			$cuposLunes 	=  $opciones_servicio['et_meta_dias_activo_lunes'][0] ;
		
		if ( isset($opciones_servicio['bloque_martes'][0]) )	
			$cuposMartes 	=  $opciones_servicio['et_meta_dias_activo_martes'][0] ;
	
		if ( isset($opciones_servicio['bloque_miercoles'][0]) )		
			$cuposMiercoles =  $opciones_servicio['et_meta_dias_activo_miercoles'][0] ;
		
		if ( isset($opciones_servicio['bloque_jueves'][0]) )	
			$cuposJueves 	=  $opciones_servicio['et_meta_dias_activo_jueves'][0] ;
		
		if ( isset($opciones_servicio['bloque_viernes'][0]) )	
			$cuposViernes 	=  $opciones_servicio['et_meta_dias_activo_viernes'][0] ;
		
		if ( isset($opciones_servicio['bloque_sabado'][0]) )	
			$cuposSabado 	=  $opciones_servicio['et_meta_dias_activo_sabado'][0] ;
		
		if ( isset($opciones_servicio['bloque_domingo'][0]) )	
			$cuposDomingo 	=  $opciones_servicio['et_meta_dias_activo_domingo'][0] ;	
		/* ******************************************** */
		?>
		...
		<div class="post-header">
			...
			<?php if ($kleo_post_format != 'status'): ?>
				<span class="muted pull-right tipo_servicio"><?php echo $tipo; ?></span>
				...
				<?php if ( $tipo == "cupos" ) : 	 ?>
					<div class="dias masonry">
						<ul>
							...
							/* ******************************************	*/
							if ( !isset($opciones_servicio['disponibilidad_servicio']) && ( isset($cuposDomingo) || isset($cuposLunes) || isset($cuposMartes) || isset($cuposMiercoles) || isset($cuposJueves) || isset($cuposViernes) || isset($cuposSabado) ) ): ?>
								<?php if ($cuposLunes == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">LU</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">LU</li>
								<?php endif; ?>
								
								<?php if ($cuposMartes == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">MA</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">MA</li>
								<?php endif; ?>
								
								<?php if ($cuposMiercoles == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">MI</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">MI</li>
								<?php endif; ?>
								
								<?php if ($cuposJueves == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">JU</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">JU</li>
								<?php endif; ?>
								
								<?php if ($cuposViernes == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">VI</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">VI</li>
								<?php endif; ?>
								
								<?php if ($cuposSabado == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">SA</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">SA</li>
								<?php endif; ?>
								
								<?php if ($cuposDomingo == 'on' ): 	 ?>
									<li class="dia_activo dia_circulo">DO</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">DO</li>
								<?php endif; ?>
							
							<?php elseif ( isset( $opciones_servicio['disponibilidad_servicio'][0]  ) ): 
								
								$disponibilidad = unserialize($opciones_servicio['disponibilidad_servicio'][0]); ?>
								
								<?php if ($disponibilidad["lunes"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">LU</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">LU</li>
								<?php endif; ?>
								
								<?php if ($disponibilidad["martes"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">MA</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">MA</li>
								<?php endif; ?>
								
								<?php if ($disponibilidad["miercoles"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">MI</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">MI</li>
								<?php endif; ?>
								
								<?php if ($disponibilidad["jueves"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">JU</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">JU</li>
								<?php endif; ?>
								
								<?php if ($disponibilidad["viernes"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">VI</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">VI</li>
								<?php endif; ?>
								
								<?php if ($disponibilidad["sabado"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">SA</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">SA</li>
								<?php endif; ?>
								
								<?php if ($disponibilidad["domingo"]["activo"] ): 	 ?>
									<li class="dia_activo dia_circulo">DO</li>
								<?php else: ?>
									<li class="dia_inactivo dia_circulo">DO</li>
								<?php endif; ?>
				...
				<?php elseif ( $tipo == "evento" ) :
					...
					$fecha_inico 	= Estilotu_Public::et_date_translate( $opciones_servicio["et_date_from"][0] . " " . $opciones_servicio["et_time_from"][0] );
					?>
		...
		<div class="post-footer">
			<small>
				...
				<p class="label_precio">
					<?php 
					if ($opciones_servicio['et_meta_precio_visibilidad'][0] == "private"): ?>
					
						<!-- <p>El precio de este servicio es privado</p> -->
					
					<?php 
					elseif ($opciones_servicio['et_meta_precio_visibilidad'][0] == "hidden"): ?>
					...
					<?php 
						...
						if ( is_float( $opciones_servicio['et_meta_precio'][0] ) ): ?>
				...
				<?php if ( get_the_author_meta ( 'ID' ) == $current_user->ID ): ?>
					...
					<a href="<?php echo esc_url(add_query_arg( array( 'id_servicio' => get_the_ID() , 'tipo_servicio' => $tipo ), bp_loggedin_user_domain() . 'servicios/agregar_servicio/' ) ); ?>"><span class="muted pull-right editar_servicio">Editar</span></a>
					<a onclick="return confirm('Seguro que quieres eliminar este servicio?')" href="<?php echo get_delete_post_link( get_the_ID() ) ?>"><span class="muted pull-left eliminar_servicio">Eliminar</span></a>

				<?php  endif; ?>
				
				<a href="<?php the_permalink();?>"><span class="muted pull-right reservar_servicio">Reservar</span></a>
